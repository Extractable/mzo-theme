...
jQuery(function() {
  ...
  jQuery(".one-third-filtered-product-card #filter-toggle .btndone").click(function(e) {
    e.preventDefault();
    jQuery("html, body").animate({ scrollTop: jQuery(".productloaddata").offset().top-100 }, 500);
  });
  ...
  jQuery(".classdata #filter-toggle .btndone").click(function(e) {
    e.preventDefault();
    jQuery("html, body").animate({ scrollTop: jQuery(".classloaddata").offset().top-100 }, 500);
  });
